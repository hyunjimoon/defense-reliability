...
@component.add(
    name="Natural Failure Count distribution",
    units="dmnl",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={
...
def natural_failure_count_distribution():
    return stats.truncnorm.rvs(
        rn_minimum(), rn_maximum(), loc=mean(), scale=standard_deviation(), size=()
    )


@component.add(
    name="standard deviation", units="dmnl", comp_type="Constant", comp_subtype="Normal"
)
...
@component.add(
    name="rN maximum", units="dmnl", comp_type="Constant", comp_subtype="Normal"
)
def rn_maximum():
    return 80
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"predictive_maintenance": 1, "estimated_failure_count": 1},
)
def maintenance():
    """
    N of Predictive Maintenance
    """
    return predictive_maintenance() + estimated_failure_count()
...
def demand():
    """
    Demand needs complicated dgp e.g. generate with prophet with multiseasonality
    """
    return maintenance()
