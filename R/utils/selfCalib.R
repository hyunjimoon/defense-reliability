...
selfCalib <- function(stan_model, prior, pars, data, N, M, cnt, evolve_df, delivDir, is_param = NULL){ # this is par, not var. var affects iter_stop.
  ...
  if (iter_stop(t_prior, t_post, bins)){
    dist_save(t_prior, delivDir, cnt)
    dist_save(evolve_df, delivDir, cnt,  type = "evolve")
