...
To prevent underfitting, we want latent variable $\mu$ to fit better to observed data $y$. So we decided to give smaller prior for `sigma_error_ship`. ($\because y \sim N(\mu, \sigma_{error\ ship})$)@
